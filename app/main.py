# create a new virtual environtment:
    # py -3 -m venv name
#activate venv:
    #path to activate.bat file in venv Scripts folder
    #venv\Scripts\activate.bat  here venv is folder name of the environment we want to use

#fastapi tutorial: https://fastapi.tiangolo.com/tutorial/

#pip install fastapi[all]  installed all the fastapi dependencies

#to run the api server: uvicorn main:app --reload  the reload flag reloads the api if there are any code changes
                #uvicorn app.main:app --reload   here app.main main look in the app folder for main.py
...
class Post(BaseModel):
    title: str
    content: str
    published: bool = True #give a default value that will be used if none provided in body or request 
...
def get_post(id: int): #id:int will validate that id is int and will try tomconvert if it is possible, else will return error
